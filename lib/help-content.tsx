      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1 text-[var(--text-secondary)]">
            ...
            <li><strong>Copy Diffs:</strong> Copy the missing lines grouped by each side label, including a line count in the section header</li>
